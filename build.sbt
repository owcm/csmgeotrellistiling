...
libraryDependencies ++= Seq(
  "com.azavea.geotrellis" %% "geotrellis-spark" % "0.10.0-31e8edc",
  "com.azavea.geotrellis" %% "geotrellis-engine" % "0.10.0-31e8edc",
  "com.azavea.geotrellis" %% "geotrellis-raster" % "0.10.0-31e8edc",
